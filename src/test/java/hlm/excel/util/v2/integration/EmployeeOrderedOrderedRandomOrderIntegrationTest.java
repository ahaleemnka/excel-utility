package hlm.excel.util.v2.integration;

import hlm.excel.util.v2.ExcelMapper;
import hlm.excel.util.v2.integration.dto.EmployeeRandom;
...
public class EmployeeOrderedOrderedRandomOrderIntegrationTest {
    ...
    void testDynamicColumnOrderingAndHeaderNameGeneration() throws Exception {
        ...
        // Use ExcelMapper to generate the Excel workbook
        ExcelMapper excelMapper = new ExcelMapper();
        Workbook workbook = excelMapper.mapToExcel(employeeList);
