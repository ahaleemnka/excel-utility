...
public class ObjectValueExtractor {
    ...
    public Object process(Object object, Field field) {
        if (object == null) {
            throw new NullPointerException("hlm.excel.util.v2.extractor.process() Object is null");
        }
        if (field == null) {
            throw new NullPointerException("hlm.excel.util.v2.extractor.process() Field is null");
        }
