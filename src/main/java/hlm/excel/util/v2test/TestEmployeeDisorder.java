...
public class TestEmployeeDisorder {
    public static void main(String[] args) throws Exception {
        ...
        try (Workbook workbook = excelMapper.mapToExcel(employeeDisorderList); FileOutputStream fileOut = new FileOutputStream(EmployeeDisorder.class.getSimpleName() + ".xlsx")) {
