package com.excel.utility.v2test;
...
public class TestEmployeeDisorder {
    public static void main(String[] args) throws Exception {
        List<EmployeeDisorder> employeeDisorderList = new ArrayList<>();

        employeeDisorderList.add(new EmployeeDisorder(1001, "John Doe", true, 60000.00, 30, new Date(), 4.5, true,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1002, "Jane Smith", false, 75000.00, 28, new Date(), null, null,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1003, "Alice Brown", true, 85000.00, 35, new Date(), 5.0, true,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1004, "Bob White", true, 95000.00, 40, new Date(), 4.0, false,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1005, "Charlie Black", true, 105000.00, null, new Date(), 3.5, true,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1006, "David Green", false, 55000.00, 45, null, 4.0, true,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1007, "Eve Blue", true, 78000.00, 33, new Date(), 4.3, null,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1008, "Frank Gray", true, 63000.00, 29, new Date(), 4.7, true,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1009, "Grace Yellow", false, 95000.00, 38, new Date(), 4.1, true,
        ...
        employeeDisorderList.add(new EmployeeDisorder(1010, "Henry Red", true, 52000.00, 50, new Date(), 3.8, false,
        ...
        try (Workbook workbook = excelUtility.mapToExcel(employeeDisorderList); FileOutputStream fileOut = new FileOutputStream(EmployeeDisorder.class.getSimpleName() + ".xlsx")) {
