...
public class TestEmployeeOrdered {
    public static void main(String[] args) throws Exception {
        ...
        try (Workbook workbook = excelUtility.mapToExcel(employeeOrderedList); FileOutputStream fileOut = new FileOutputStream(EmployeeOrdered.class.getSimpleName() + ".xlsx")) {
